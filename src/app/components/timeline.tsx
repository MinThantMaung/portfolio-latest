...
const Timeline = () => {
  return (
    <>
      <h2 className="ml-4 md:ml-32 font-bold text-3xl">
        {staticData.experience_and_certification}
      </h2>
      <div className="mx-4 md:mx-32 my-4">{staticData.exp_descrition}</div>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical mx-4 md:mx-32">
        <li>
